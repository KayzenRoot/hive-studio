...
|---|---|---|---:|
| T0 Foundation fast gate | Every PR | Source Pack, exact submodule SHAs and versions | 5 minutes |
...
The current repository implements T0 and a separate GEF source-validation job capped at 30 minutes. Product T1–T4 suites are not claimed to exist.
